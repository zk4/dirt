...
状态驱动, 嗯, 想当年 HEATOS 也是这么想的. 但其实状态驱动差了很多东西. 最大的痛諔是它没有数据之间的关系.
...
1. 模板代码就是模板代码，通常很难达到生成就能用的程度。你还是得有前端熟悉的人去改，或者部署。 稍微一点定制比较容易瞎。
...
做个约定。要么关联，要么创建。api 分开。体现在 UI 上会形成两次操作。
