...
public class SimpleJpaRepositoryX<T, ID> implements JpaRepositoryImplementation<T, ID> {
	...
	/**
	 * Creates a new {@link SimpleJpaRepositoryX} to manage objects of the given {@link JpaEntityInformation}.
	 *
	 * @param entityInformation must not be {@literal null}.
	 * @param entityManager must not be {@literal null}.
	 */
	public SimpleJpaRepositoryX(JpaEntityInformation<T, ?> entityInformation, EntityManager entityManager) {
	...
	/**
	 * Creates a new {@link SimpleJpaRepositoryX} to manage objects of the given domain type.
	 *
	 * @param domainClass must not be {@literal null}.
	 * @param em must not be {@literal null}.
	 */
	public SimpleJpaRepositoryX(Class<T> domainClass, EntityManager em) {
	 ...
	 * {@link SimpleJpaRepositoryX#findAllById(Iterable)}. Workaround for OpenJPA not binding collections to in-clauses
