...
public class CreateMember {
    ...
    public void createMember(@RequestBody  CreateMemberReq req) throws IllegalAccessException, JsonProcessingException, IntrospectionException, InstantiationException, InvocationTargetException, ClassNotFoundException {
